...
public class CargarEjerciciosEspaldaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cargar_ejercicios_espalda);

        ListaEjer = new ArrayList<>();
        asociarElementos();
        ejercicioRepository = new EjercicioRepository(CargarEjerciciosEspaldaActivity.this);
    ...
    private void configuarListado() {
        rvlistadoEjercicios .setLayoutManager(new LinearLayoutManager(CargarEjerciciosEspaldaActivity.this));
        ...
        miAdapter.setOnItemClickListener(new EjerciciosAdapter.OnItemClickListener() {
            ...
            public void onItemClick(Ejercicio miEjercicio, int posicion) {
                Toast.makeText(CargarEjerciciosEspaldaActivity.this, "Car"+ miEjercicio.getTituloEjercicio(), Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(CargarEjerciciosEspaldaActivity.this, DetalleEjerciciosActivity.class);
            ...
            public void onItemClickImagen(Ejercicio miEjercicio, int posicion) {
                Toast.makeText(CargarEjerciciosEspaldaActivity.this, "Imagen "+miEjercicio.getTituloEjercicio(), Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private  void actualizarListado(){
        ejercicioRepository.obtenerTodosFSEspalda(new TaskWorkoutCallBack<ArrayList<Ejercicio>>() {
            @Override
            ...
            public void tareaError(Exception exception) {
                Toast.makeText(CargarEjerciciosEspaldaActivity.this, "ERROR ", Toast.LENGTH_SHORT).show();
            }
        });
